...
/**
 * 用于显示认证服务器的批准授权页面的控制器.
 * 默认用于显示认证服务器的批准授权页面的控制器请参见{@link WhitelabelApprovalEndpoint}
 *
 * @author Dave Syer
 */
@RestController
...
public class SsoApprovalEndPoint {
    ...
    // 这里修改TEMPLATE,即修改显示认证服务器的批准授权页面,实现无需用户手动批准授权,自动提交授权表单
    private static String TEMPLATE = "<html><body><h2>Auto Authorize Success, Redirecting......</h2><div style='display:none;'><h1>OAuth Approval</h1>"
